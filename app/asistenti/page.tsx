...
export const metadata = {
  title: 'AI workshop - Pokročilý kurz',
  description: 'Specializovaný pokročilý kurz AI pro realitní makléře, obchodníky a investory. Naučte se využívat umělou inteligenci pro zvýšení produktivity a efektivity vaší práce.',
}
  ...
  return (
      <>
        <Hero
            ...
            dates={courseDates.filter(date => date.level === 'advanced')}
            video={{
        ...
        <CourseProgramme
            ...
            dates={courseDates.filter(date => date.level === 'advanced')}
            beginnerProgramme={advancedProgramme}
            cta={{
              primary: {
                text: "Koupit s podporou",
                href: "https://www.uradprace.cz/web/cz/vyhledani-rekvalifikacniho-kurzu#/rekvalifikacni-kurz-detail/18900",
